...
import { type LucideIcon, ArrowRight, BarChart3, Layout, TrendingDown } from "lucide-react";
...
const defaultCardsData: DisplayCardData[] = [
    {
        icon: Layout,
...
export default function DisplayCards() {
    return (
        <div className="relative w-full h-[520px] md:h-[600px] flex items-end justify-center pb-8 md:pb-20">
            <CardSwap
                delay={3000}
                        ...
                        >
                            ...
                            <div className="mb-4 md:mb-6">
                                <span className="inline-flex items-center justify-center size-11 md:size-14 rounded-2xl bg-[#1a1a1a] ring-1 ring-white/6">
                                    <Icon className="size-5 md:size-6 text-coral" />
                                </span>
                            </div>
